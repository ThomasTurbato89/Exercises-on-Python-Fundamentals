...
while True:
    ...
    strike, ball = ContaUgualiInStessoEInAltro(l1, sd)
    if strike == len(l1):
        print("Hai vinto")
        break
    else:
        print("i numeri nel posto giusto sono: ", strike, "mentre i numeri giusti ma messi nel posto sbagliato sono: ", ball)
